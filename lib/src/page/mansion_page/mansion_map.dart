...
class MansionMap extends StatefulWidget {

  @override
  _MansionMapState createState() => _MansionMapState();
}

class _MansionMapState extends State<MansionMap> {
  ...
  Future<void> _dummyLoction() async {
    ...
    List<LatLng> data = [
      LatLng(6.871815102089425, 101.23807859738987), //เจริญประดิษฐ์แมนชั่น
      LatLng(6.861472044016104, 101.24536175076241), //เรนโบว์แมนชั่น
      LatLng(6.876578364573431, 101.24331832622661), //สุมินตราแมนชั่น
    ];

    List<String> placeName = ['เจริญประดิษฐ์แมนชั่น','เรนโบว์แมนชั่น','สุมินตราแมนชั่น'];
