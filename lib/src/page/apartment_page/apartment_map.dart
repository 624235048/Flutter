...
class ApartmentMap extends StatefulWidget {

  @override
  _ApartmentMapState createState() => _ApartmentMapState();
}

class _ApartmentMapState extends State<ApartmentMap> {
  ...
  Future<void> _dummyLoction() async {
    ...
    List<LatLng> data = [
      LatLng(6.870838860936966, 101.22861714121812), //Green Residence Pattani
      LatLng(6.872842039061381, 101.23732477959908), //บี.เอ็ม. ปัตตานี อพาร์ทเมนท์
      LatLng(6.8697562655127635, 101.23691977099763), //บีโฟร์ปัตตานี
      LatLng(6.867833018185724, 101.23931090904678), //เจริญประดิษฐ์อพาร์ทเม้น
      LatLng(6.87187669649502, 101.23808529738993), //บีทูอพาร์ทเม้นท์
      LatLng(6.873411541158702, 101.2388473562854), //เจ.ซี อพาร์ทเม้นท์
    ];

    List<String> placeName = ['Green Residence Pattani','บี.เอ็ม. ปัตตานี อพาร์ทเมนท์','บีโฟร์ปัตตานี','เจริญประดิษฐ์อพาร์ทเม้น','บีทูอพาร์ทเม้นท์','เจ.ซี อพาร์ทเม้นท์'];
