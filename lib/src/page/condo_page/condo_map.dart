...
class CondoMap extends StatefulWidget {
  @override
  State<CondoMap> createState() => CondoMapState();
}

class CondoMapState extends State<CondoMap> {
  ...
  Future<void> _dummyLoction() async {
    ...
    List<LatLng> data = [
      LatLng(6.863440265838631, 101.25093809779916), //Yensabaidee Condo
      LatLng(6.8709722189149005, 101.23890368553033), //Pattani Place Condotel
    ];

    List<String> placeName = ['Yensabaidee Condo','Pattani Place Condotel'];
