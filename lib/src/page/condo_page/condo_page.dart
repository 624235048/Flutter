...
import 'package:miniproject/src/page/condo_page/condo_body_page.dart';
  ...
  AppBar _buildAppBar() {
    return AppBar(
      ...
      actions: <Widget>[
        ...
        //onTap : () => showBottomSheet(context: context, builder: (context) => CondoBodyPage(),),
        IconButton(
          icon: ClipOval(
            child: Icon(Icons.add, color: Colors.white),
          ),
          onPressed: () {
            Navigator.pushNamed(context, AppRoute.CondoManagementRoute);
          },
        )
      ],
    );
...
//     bool _checkboxValue3 = false;
//     bool _checkboxValue4 = false;
//     showBottomSheet(context: context, builder: (BuildContext bc){
//       return Container(
