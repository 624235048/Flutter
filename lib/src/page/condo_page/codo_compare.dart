...
class CondoCompare extends StatefulWidget {
  @override
  _CondoCompareState createState() => _CondoCompareState();
}

class _CondoCompareState extends State<CondoCompare> {
  ...
  AppBar _buildAppBar(BuildContext context) {
    return AppBar(
      title: Text('Compare Condominium'),
      centerTitle: true,
