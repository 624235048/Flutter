...
CondoModel condoModelFromJson(String str) =>
    CondoModel.fromJson(json.decode(str));
...
class Condo {
  ...
  factory Condo.fromJson(Map<String, dynamic> json) => Condo(
        ...
        condoReview: json["condo_review"],
        condoImage2: json["condo_image2"],
        condoImage3: json["condo_image3"],
        condoImage4: json["condo_image4"],
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "condo_review": condoReview,
        "condo_image2": condoImage2,
        "condo_image3": condoImage3,
        "condo_image4": condoImage4,
      };
}
